                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div className="heading4">
                            <span className="span" data-aos="zoom-in-left" data-aos-duration="700" style={{fontSize: '18px', fontWeight: '600'}}>{subTitle}</span>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-md-4">
                                    <ul className="list" data-aos="fade-left" data-aos-duration="800" style={{ whiteSpace: "nowrap" }}>
